...
`
    ...
    registerTest(
      {
        title: `it should not eliminate patterns when all fox tiles are marked empty (solved board otherwise)`,
        tags: [],
      },
      `
      ┌─────┬─────┬─────┬─────┬─────┬─────┐
...
`
    ...
    registerTest(
      {
        title: `it should not eliminate patterns when all fox tiles are marked empty (unsolved board)`,
        tags: [],
      },
      `
      ┌─────┬─────┬─────┬─────┬─────┬─────┐
